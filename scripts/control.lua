...
script.on_event(defines.events.on_built_entity, onBuiltEntity, { { filter = "name", name = Config.CHEST_NAME } })
script.on_event(defines.events.on_robot_built_entity, onBuiltEntity, { { filter = "name", name = Config.CHEST_NAME } })
script.on_event(defines.events.script_raised_built, onBuiltEntity, { { filter = "name", name = Config.CHEST_NAME } })
